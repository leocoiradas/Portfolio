    ...
    return (
        <article className={`w-[70vw] flex justify-center items-center flex-wrap gap-2 border-2 rounded-md border-purple-600 p-3`}>
            ...
            <div className="flex flex-col justify-center items-start flex-1 gap-3">
                ...
                {socialInfo.mail ? (<a href={`mailto:${socialInfo.to}`} target="_blank" className="bg-cyan-500 hover:bg-blue-700 rounded-md px-6 py-2">Go</a>)
                :
                <a href={socialInfo.to} target="_blank" className="bg-cyan-500 hover:bg-blue-700 rounded-md px-6 py-2">Go</a>}
            </div>
        </article>
    )
}
