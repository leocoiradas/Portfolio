...
function LoadingData(){
    ...
    return (
        <article className="flex  justify-center items-center backdrop-blur-sm bg-black/30 p-4 gap-3">
            ...
            <p className="font-mono text-white text-2xl">{t("projects.loadingData")}</p>
        </article>
    )
}
