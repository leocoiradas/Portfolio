    ...
    return (
        <div className="flex flex-col">
            <div className="w-full flex justify-end items-center">
                <button name={openSwitch ? t("navbar-button.name-close") : t("navbar-button.name-open")} onClick={buttonSwitch} className="flex flex-col justify-center items-center  p-4 rounded-md border-2 border-transparent transition-all duration-300 lg:hidden">
                    {openSwitch ?
